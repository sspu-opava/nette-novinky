<?php
// source: D:\studenti\it3\novinky\app/config/config.neon 
// source: D:\studenti\it3\novinky\app/config/config.local.neon 

class Container_8daa3cb4ba extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\NewsManager' => [1 => ['28_App_Model_NewsManager']],
			...
			'App\Presenters\NewsPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'28_App_Model_NewsManager' => 'App\Model\NewsManager',
			...
			'application.4' => 'App\Presenters\NewsPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\studenti\it3\novinky\app',
			'wwwDir' => 'D:\studenti\it3\novinky\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'D:\studenti\it3\novinky\app/../temp',
		];
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('28_App_Model_NewsManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\NewsPresenter
	 */
	public function createServiceApplication__4()
	{
		$service = new App\Presenters\NewsPresenter($this->getService('28_App_Model_NewsManager'),
			$this->getService('29_App_Model_UserManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
	...
	{
		$service = new App\Presenters\UserPresenter($this->getService('29_App_Model_UserManager'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\studenti\it3\novinky\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('D:\studenti\it3\novinky\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('D:\studenti\it3\novinky\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=zpravy', 'root',
			NULL, ['lazy' => TRUE]);
	...
	{
		return new Container_8daa3cb4ba_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_8daa3cb4ba_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_8daa3cb4ba $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('D:\studenti\it3\novinky\app/../temp/cache/latte');
